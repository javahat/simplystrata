...
$previous_type = NULL;
	...
	$args = array(
		...
		'meta_value' => 'Council Only Document',
	...
	if ( $document_posts ) 
		...
		<div class="document-section">
			<table class="document-list" title="All Documents" cellpadding="0" cellspacing="0">
				<thead>
					<tr><td colspan="3"><h2>All Documents</h2></td></tr>
	...
	// Format the posted date to compare with the 'new date' specified above
	$posted = get_the_date();
